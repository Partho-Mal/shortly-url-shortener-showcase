// //next-frontend\app\signup\pro\page.tsx
'use client';

export default function ProSignupPage()  {
  return(
    <div>
      If we get traffic on this site we might consider adding ads free redirect page with a pro plan
      <br/>
      Thanks for Checking!
    </div>
  );
...
//     try {
//       const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/google/login/billing`, {
//         method: 'POST',
//         headers: {
...
//         body: JSON.stringify({
//           ...form,
//           plan: 'pro', // Automatically assign pro plan
//         }),
//       });
...
//   return (
//     <div className="bg-muted flex min-h-screen flex-col items-center p-6 md:p-10">
...
//           <CardHeader>
//             <CardTitle className="text-xl text-center">Join the Pro Plan</CardTitle>
//             <p className="text-center text-muted-foreground text-sm">
//               Sign up and unlock Pro features instantly.
//             </p>
//           </CardHeader>
...
//               className="w-full"
//               onClick={() => {
//                 window.location.href = `${process.env.NEXT_PUBLIC_BACKEND_URL}/google/login/billing`;
//               }}
//             >
